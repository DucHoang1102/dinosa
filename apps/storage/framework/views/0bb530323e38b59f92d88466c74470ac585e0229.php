...
<head>
	...
	<style type="text/css">
		...
		@media  only print  {
			...
			.print-product .product .del, .print-product .product .description, hr {
				display: none;
			}
		}
	</style>
...
<body>
	<div class="container-print-product">
		<div class="print-product"> 
			<div class="product">
				<img src="http://dinosa.app/upload/d-p-1234/f-a3/D35.png">
					<span class="description">
						<b>Tên KH:</b> 
						<span class="info"> Nguyễn Đức Hoàng dfd</span>
						<hr>
						<b>SDT:</b> 
						<span class="info"> 0972982082</span>
						<hr>
						<b>Sản phẩm | Mã:</b> 
						<span class="info"> A12CT1(S) | A12</span>
						<hr>
						<b>Tổng tiền:</b> 
						<span class="info"> 250,000 vnd</span>
