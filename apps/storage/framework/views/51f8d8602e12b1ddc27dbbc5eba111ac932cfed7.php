...
<body>
	<div class="container-print-product">
		<div class="print-product">
			<?php $__currentLoopData = $orders_daXacNhan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php $__currentLoopData = $order->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<div class="product">
						<img src="/<?php echo e($product->url_image->src_f_a3); ?>">
						<span class="description">
							<b>Tên KH:</b> 
							<span class="info"> <?php echo e($order->name); ?></span>
							<hr>
							<b>SDT:</b> 
							<span class="info"> <?php echo e($order->phone); ?></span>
							<hr>
							<b>Sản phẩm | Mã:</b> 
							<span class="info"> <?php echo e($product->name); ?> | <?php echo e($product->id_image_print); ?></span>
							<hr>
							<b>Tổng tiền:</b> 
							<span class="info"><?php echo e($order->total_money); ?> vnđ</span>
						</span>
