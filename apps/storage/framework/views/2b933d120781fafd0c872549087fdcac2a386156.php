<tr>
	...
	<?php $__currentLoopData = $order->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		<div class="product-success bg-<?php echo e($product->status); ?>" status=<?php echo e($product->status); ?> id="<?php echo e($product->id); ?>" url-image="<?php echo e($product->url_image->src_f_a3); ?>"><?php echo e($product->name); ?><span class="glyphicon glyphicon-remove"></span></div>
	...
	<td class='xacnhan functions'>
		<?php echo $__env->make('orders.tab-content.funs.menu-funs-general', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	</td>
</tr>