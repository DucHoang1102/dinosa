...
<div class="list-bills">
	<div class="tab-content">
		...
		<!-- Tab Đơn Mới  -->
		<?php echo $__env->make('orders.tab-content.donmoi', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		
		<!-- Tab Đã xác nhận -->
		<?php echo $__env->make('orders.tab-content.daxacnhan', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

		<!-- Tab Đã in xong -->
		<?php echo $__env->make('orders.tab-content.dainxong', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

		<!-- Tab Đamg chuyển -->
		<?php echo $__env->make('orders.tab-content.dangchuyen', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

		<!-- Tab Chuyển thành công -->
		<?php echo $__env->make('orders.tab-content.chuyenthanhcong', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

		<!-- Tab Chuyển thất bại -->
		<?php echo $__env->make('orders.tab-content.chuyenthatbai', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

		<!-- Tab Thùng rác -->
		<?php echo $__env->make('orders.tab-content.thungrac', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
