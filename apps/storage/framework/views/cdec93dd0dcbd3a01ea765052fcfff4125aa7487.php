<div role="tabpanel" class="tab-pane" id="chuyenthatbai">
	...
	<div class="table-tbody">
		<?php $__currentLoopData = $orders_chuyenThatBai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $orders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					...
					<td class='xacnhan functions'>
						<div class="menu_funs">
							<?php if($order->id_orders_status == 7): ?>
								<a href="orders/move/status=8+id=<?php echo e($order->id); ?>+no_update=true"> 
							...
							<?php elseif($order->id_orders_status == 8): ?>
								<a href="orders/move/status=7+id=<?php echo e($order->id); ?>+no_update=true""> 
